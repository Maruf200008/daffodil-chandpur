...
import stepImg3 from "../../../images/steps-img-3.png";

const PowerfulAlumni = () => {
  return (
    <div className="  bg-[#032e3f] mb-20 overflow-hidden px-5 sm:px-14 xl:px-0 lg:px-[50px] ">
      <div className="  grid lg:grid-cols-2 items-start lg:items-center xl:items-start justify-between ">
        <div className=" overflow-hidden  lg:h-[800px]  mt-16 lg:mt-0 xl:h-full lg:ml-[-50px]    ">
          <Image src={stepImg3} alt="" className="  object-cover h-full " />
        </div>
          ...
          <div className=" py-10 xl:py-28 space-y-5  ">
            <div>
              <div className=" space-y-10 mt-9">
                <div className=" lg:ml-10 xl:ml-0 xl:mr-[40px]  flex  flex-col items-center justify-center text-center md:text-start md:items-start md:justify-start gap-5 mt-7 overflow-hidden ">
